/* ============================================
   ...
   Página para visualizar productos de accesorios
   (Sleeves, Deck Boxes, Playmats, etc.)
...
export async function render(container) {
    console.log('📦 Renderizando Accesorios...');
    
    container.innerHTML = getAccessoriesHTML();
    await initAccessories();
    
    console.log('✅ Accesorios renderizado');
}
            ...
            <div class="page-header">
                <div>
                    ...
                    <p class="page-subtitle">
                        Gestión de accesorios para TCG (Sleeves, Deck Boxes, Playmats, etc.)
                    </p>
                </div>
...
async function loadProducts() {
    try {
        ...
        console.log('📥 Cargando productos de /products/sealed/accessories...');
        const response = await api.get('/products/sealed/accessories', { limit: 1000 });
