/* ============================================
   GUNDAM SEALED PRODUCTS PAGE
   ============================================
   
   Página para visualizar productos sellados de Gundam
...
export async function render(container) {
    console.log('📦 Renderizando Gundam Sellado...');
    
    container.innerHTML = getGundamSealedHTML();
    await initGundamSealed();
    
    console.log('✅ Gundam Sellado renderizado');
}

/**
 * Genera el HTML
 */
function getGundamSealedHTML() {
    return `
        <div class="gundam-sealed-container">
            <!-- Header -->
            <div class="page-header">
                <div>
                    <h1 class="page-title">
                        <i class="bi bi-robot"></i>
                        Gundam: Productos Sellados
                    </h1>
                    <p class="page-subtitle">
                        Gestión de productos sellados de Gundam Card Game
                    </p>
                </div>
 ...
 */
async function initGundamSealed() {
    // Event listeners
...
async function loadProducts() {
    try {
        ...
        console.log('📥 Cargando productos de /products/sealed/gundam...');
        const response = await api.get('/products/sealed/gundam', { limit: 1000 });
        ...
        console.error('❌ Error cargando productos Gundam:', error);
    ...
    if (productsToShow.length === 0) {
        grid.innerHTML = `
            <div class="empty-state">
                ...
                <p>No se encontraron productos sellados de Gundam.</p>
            </div>
        `;
